...
class PillCreate extends Component {
                ...
                <animated.div
                  ...
                  {flipped ? component : (
                    <>
                      ...
                      <button className="pill-finish-button" onClick={this.finishPill}>-FINISH-</button>
                    </>
                  )}
                </animated.div>
              )}
  ...
  //testScreens = [this.TestScreen1, this.TestScreen2, this.TestScreen3];
  ...
  render() {
    ...
    if (finish) { return <Redirect to="/profile" /> }
